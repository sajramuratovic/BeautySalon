...
if(isset($_POST['add']))
{
  ...
  else 
  {
	...
	if(!empty($_POST["title"]) && !empty($_POST["article"]) && !empty($_POST["author"]) && $errors == 0)
   {
    ...
    $sql = "INSERT INTO articles (title, description, author) VALUES ('$title', '$description', '$author')";
  ...
  /*
    ...
    $dbname = "sajrinabaza";
     ...
     try {
          ...
          $sql = "DELETE FROM articles WHERE articleID = '$_POST[titledelete]'";
         ...
         <div class="container">
            ...
            <div class="forme">
			   ...
			   <h3>Add news</h3>
				  ...
				  <h3>Delete news</h3>
                  <div>
                     <input type="text" name="titledelete" placeholder="You must enter the id of article">
